...
//   try {
//     // Delete records from the readme table
...
//     // Delete records from the skills table
...
//     // Delete records from the github_stats table
//     const deleteStatsQuery = {
//       text: "DELETE FROM github_stats WHERE user_id = $1",
//       values: [userId],
//     };
//     await client.query(deleteStatsQuery);

//     // Delete the user record from the graduates_user table
